...
ScrollReveal().reveal('.projects_container', { duration: 600 });

ScrollReveal().reveal('.contact__form-container', { duration: 500 });

ScrollReveal().reveal('.footer__container-row1', { duration: 500 });
ScrollReveal().reveal('.socials__social', { interval: 400 });